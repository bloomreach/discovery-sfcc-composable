...
function parseEnvVar(envVarName) {
    ...
    try {
        ...
        throw new Error(`Environment variable ${envVarName} must be a valid JSON string.`)
    }
}
...
module.exports = {
    ...
    ssrParameters: {
        ...
        proxyConfigs: [
            ...
            {
                host: 'staging-suggest.dxpapi.com',
                path: 'bloomreach-autosuggest',
                protocol: 'https'
            },
            {
                host: 'pathways-staging.dxpapi.com',
